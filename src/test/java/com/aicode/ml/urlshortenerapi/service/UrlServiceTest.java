...
public class UrlServiceTest {
    ...
    public void convertToShortUrlTest() {
        var url = new Url();
        url.setLongUrl("https://github.com/zigri2612/UrlShortener-API");
        ...
        urlRequest.setLongUrl("https://github.com/zigri2612/UrlShortener-API");
    ...
    public void getOriginalUrlTest() {
        ...
        assertEquals("https://github.com/zigri2612/UrlShortener-API", urlService.getOriginalUrl("h"));
